...
class Song:
    ...
    def __init__(self, filepath=""):
        ...
        # self.year = self.audiofile.tag.year  # error:  AttributeError: 'Tag' object has no attribute 'year'
        self.genre = self.audiofile.tag.genre
        # self.length = self.audiofile.tag.length  # error:  AttributeError: 'Tag' object has no attribute 'length'
        # self.trackNumber = self.audiofile.tag.track  # error
